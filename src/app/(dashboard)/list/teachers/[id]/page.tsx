    ...
    <div className='p-4 pt-24'>
       <div className='flex-1 p-4 flex flex-col gap-4 xl:flex-row'>
        ...
        <div className='bg-sky py-6 px-4 rounded-md flex-1 flex gap-4'>
            ...
            <h1 className='text-xl font-semibold'>Leonardo dicaprio</h1>
        ...
        <div className='mt-4 bg-white rounded-md p-4 h-[800px]'>
           <h1 className='font-semibold'>Teachers Schedule</h1>
           <BigCalendar/>
        </div>
        ...
        <div className='bg-white p-4 rounded-md'>
            ...
            <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
                <Link href={'/'} className='p-2 rounded-md bg-skyLight'>Teachers Classes</Link>
                <Link href={'/'} className='p-2 rounded-md bg-sky'>Teachers Students</Link>
                <Link href={'/'} className='p-2 rounded-md bg-yellow'>Teachers Lessons</Link>
                <Link href={'/'} className='p-2 rounded-md bg-yellowLight'>Teachers Exams</Link>
                <Link href={'/'} className='p-2 rounded-md bg-skyLight'>Teachers Assigments</Link>
            </div>
        </div>
        {/* chart */}
        <PerformanceChart/>
